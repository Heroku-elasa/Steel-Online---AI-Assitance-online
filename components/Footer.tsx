                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-6 md:col-span-1">
                        <div className="flex items-center space-x-3 rtl:space-x-reverse group">
                             <img src={customLogo} alt="Steel Online Logo" className="w-16 h-16 rounded-full object-cover border-2 border-brand-gold group-hover:scale-105 transition-transform" />
                             <div className="flex flex-col">
                                <span className="font-bold text-2xl text-gray-900 dark:text-white group-hover:text-brand-gold transition-colors">استیل آنلاین</span>
                                <span className="text-xs text-gray-500 tracking-wider">بازار هوشمند آهن</span>
                             </div>
                        </div>
                        ...
                        <div className="flex flex-col space-y-2">
                            <span className="text-xs font-bold text-gray-500">Find us on:</span>
                            <div className="flex space-x-4 rtl:space-x-reverse">
                                <a href="#" className="text-gray-400 hover:text-brand-gold transition-colors text-xs font-medium">Google Maps</a>
                                <a href="#" className="text-gray-400 hover:text-brand-gold transition-colors text-xs font-medium">Neshan</a>
                                <a href="#" className="text-gray-400 hover:text-brand-gold transition-colors text-xs font-medium">Balad</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-4 text-sm">
                            <li className="flex items-start">
                                ...
                                <div className="mt-1">
                                    <span className="block text-xs text-gray-500 mb-1">ایمیل فروش</span>
                            ...
                            <li className="flex items-start">
                                <div className="w-8 h-8 rounded bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-brand-gold mr-3 rtl:ml-3 rtl:mr-0 flex-shrink-0">📍</div>
                                <div className="mt-1">
                                    <span className="block text-xs text-gray-500 mb-1">دفتر مرکزی</span>
                             ...
                             <li className="flex items-start">
                                <div className="w-8 h-8 rounded bg-gray-200 dark:bg-gray-800 flex items-center justify-center text-brand-gold mr-3 rtl:ml-3 rtl:mr-0 flex-shrink-0">📞</div>
                                <div className="mt-1">
                                    <span className="block text-xs text-gray-500 mb-1">تلفن تماس</span>
