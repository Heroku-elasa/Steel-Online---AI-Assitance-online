...
const Sidebar: React.FC<Props> = ({ currentView, onViewChange, mobileMenuOpen, setMobileMenuOpen }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div className={`
        fixed inset-y-0 z-50 w-80 bg-brand-black text-white flex flex-col h-full
        transform transition-transform duration-300 ease-in-out shadow-2xl
        lg:static lg:transform-none lg:shadow-none lg:z-40
      ...
      `}>
        ...
        <nav className="px-4 py-4">
            <ul className="space-y-1">
                ...
                <li>
                    <button 
                      onClick={() => handleNavClick('finetuning')}
                ...
                <li>
                    <button 
                      onClick={() => handleNavClick('wp_dashboard')}
