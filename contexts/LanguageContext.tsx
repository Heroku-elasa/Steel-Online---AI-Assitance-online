...
const translations: Record<Language, Record<string, string>> = {
  fa: {
    ...
    nav_resources: 'منابع و ابزار سئو',
    ...
    // Resources & Templates
    res_title: 'مرکز دانش و ابزار سئو',
    res_subtitle: 'استانداردهای حسابداری جدید، فایل‌های نمونه و ابزار بررسی سئو',
    res_tab_files: 'فایل‌ها و استانداردها',
    res_tab_seo: 'آنالیزور سئو (SEO Health)',
    ...
    // SEO Tool
    seo_btn_analyze: 'شروع آنالیز سئو',
    seo_analyzing: 'در حال بررسی صفحه...',
    seo_score_title: 'امتیاز سلامت سئو',
    seo_rec_title: 'توصیه‌های بهبود',
    seo_issue_title: 'اشکالات یافت شده',
    seo_good_job: 'نقاط قوت',
    seo_reg_tools: 'ثبت سایت در موتورهای جستجو',
    seo_reg_gsc: 'ثبت در Google Search Console',
    seo_reg_bing: 'ثبت در Bing Webmaster',
    seo_missing_h1: 'تگ H1 یافت نشد',
    seo_title_short: 'عنوان صفحه کوتاه است',
    seo_desc_missing: 'توضیحات متا (Meta Description) یافت نشد',
    seo_alt_missing: 'تصاویر بدون متن جایگزین (Alt)',
    seo_missing_og: 'تگ‌های شبکه‌های اجتماعی (Open Graph) یافت نشد',
    ...
    // Steel Online - Google Sheets
    nav_gsheet: 'مدیریت چک (گوگل شیت)',
    gsheet_connect_title: 'اتصال به حساب گوگل',
    gsheet_connect_desc: 'برای مدیریت چک‌های برگشتی در محیط امن گوگل شیت، لطفا حساب خود را متصل کنید.',
    gsheet_btn_connect: 'ورود با گوگل',
    gsheet_syncing: 'در حال همگام‌سازی...',
    gsheet_synced: 'همگام‌سازی شد',
    gsheet_filename: 'لیست_چک‌های_برگشتی_۱۴۰۴',
  },
  en: {
    ...
    nav_resources: 'Resources & SEO Tools',
    ...
    res_title: 'Knowledge Base & SEO Tools',
    res_subtitle: 'New Accounting Standards, Sample Files and SEO Checker',
    res_tab_files: 'Files & Standards',
    res_tab_seo: 'SEO Analyzer',
    ...
    res_erp_desc: 'Automate these reports by connecting to ShAuto ERP.',
    
    // SEO Tool
    seo_btn_analyze: 'Start SEO Analysis',
    seo_analyzing: 'Scanning Page...',
    seo_score_title: 'SEO Health Score',
    seo_rec_title: 'Recommendations',
    seo_issue_title: 'Issues Found',
    seo_good_job: 'Good Job!',
    seo_reg_tools: 'Search Engine Registration',
    seo_reg_gsc: 'Register on Google Search Console',
    seo_reg_bing: 'Register on Bing Webmaster',
    seo_missing_h1: 'Missing H1 Tag',
    seo_title_short: 'Title is too short',
    seo_desc_missing: 'Missing Meta Description',
    seo_alt_missing: 'Images missing Alt text',
    seo_missing_og: 'Missing Open Graph (Social) Tags',
    ...
    // Steel Online - Google Sheets
    nav_gsheet: 'Check Management (Google Sheets)',
    gsheet_connect_title: 'Connect to Google Account',
    gsheet_connect_desc: 'To manage returned checks in a secure Google Sheet environment, please connect your account.',
    gsheet_btn_connect: 'Sign in with Google',
    gsheet_syncing: 'Syncing...',
    gsheet_synced: 'Synced',
    gsheet_filename: 'Returned_Checks_List_1404',
  },
  ar: {
    app_title: 'حسابرس‌یار',
    ...
    res_title: 'قاعدة المعرفة وأدوات SEO',
    res_subtitle: 'معايير المحاسبة الجديدة وأداة فحص SEO',
    res_tab_files: 'الملفات والمعايير',
    res_tab_seo: 'محلل SEO',
    ...
    // SEO Tool
    seo_btn_analyze: 'تحليل SEO',
    seo_analyzing: 'جاري الفحص...',
    seo_score_title: 'درجة صحة SEO',
    seo_rec_title: 'التوصيات',
    seo_issue_title: 'المشاكل التي تم العثور عليها',
    seo_good_job: 'عمل جيد!',
    seo_reg_tools: 'التسجيل في محركات البحث',
    seo_reg_gsc: 'التسجيل في Google Search Console',
    seo_reg_bing: 'التسجيل في Bing Webmaster',
    seo_missing_h1: 'علامة H1 مفقودة',
    seo_title_short: 'العنوان قصير جداً',
    seo_desc_missing: 'وصف الميتا مفقود',
    seo_alt_missing: 'صور بدون نص بديل',
    seo_missing_og: 'علامات الشبكة الاجتماعية مفقودة',
    ...
    nav_gsheet: 'إدارة الشيكات (Google Sheets)',
    gsheet_connect_title: 'الاتصال بحساب Google',
    gsheet_connect_desc: 'لإدارة الشيكات المرتجعة في بيئة آمنة، يرجى ربط حسابك.',
    gsheet_btn_connect: 'تسجيل الدخول باستخدام Google',
    gsheet_syncing: 'جاري المزامنة...',
    gsheet_synced: 'تمت المزامنة',
    gsheet_filename: 'قائمة_الشيكات_المرتجعة_1404',
  },
  sv: {
    app_title: 'HesabrasYar',
    ...
    nav_resources: 'Resurser & SEO-verktyg',
    ...
    res_title: 'Resurser & SEO-verktyg',
    res_subtitle: 'Nya redovisningsstandarder och SEO-kontroll',
    res_tab_files: 'Filer & Standarder',
    res_tab_seo: 'SEO-analysator',
    ...
    // SEO Tool
    seo_btn_analyze: 'Starta SEO-analys',
    seo_analyzing: 'Skannar sidan...',
    seo_score_title: 'SEO Hälsopoäng',
    seo_rec_title: 'Rekommendationer',
    seo_issue_title: 'Upptäckta problem',
    seo_good_job: 'Bra jobbat!',
    seo_reg_tools: 'Sökmotorregistrering',
    seo_reg_gsc: 'Registrera på Google Search Console',
    seo_reg_bing: 'Registrera på Bing Webmaster',
    seo_missing_h1: 'Saknar H1-tagg',
    seo_title_short: 'Titeln är för kort',
    seo_desc_missing: 'Saknar metabeskrivning',
    seo_alt_missing: 'Bilder saknar Alt-text',
    seo_missing_og: 'Saknade sociala medier-taggar',
    ...
    nav_gsheet: 'Checkhantering (Google Sheets)',
    gsheet_connect_title: 'Anslut till Google-konto',
    gsheet_connect_desc: 'För att hantera returnerade checkar i en säker miljö, anslut ditt konto.',
    gsheet_btn_connect: 'Logga in med Google',
    gsheet_syncing: 'Synkroniserar...',
    gsheet_synced: 'Synkroniserad',
    gsheet_filename: 'Returnerade_Checkar_1404',
  },
  tr: {
    app_title: 'HesabrasYar',
    ...
    nav_resources: 'Kaynaklar & SEO Araçları',
    ...
    res_title: 'Bilgi Tabanı ve SEO Araçları',
    res_subtitle: 'Yeni Muhasebe Standartları ve SEO Kontrolü',
    res_tab_files: 'Dosyalar ve Standartlar',
    res_tab_seo: 'SEO Analizörü',
    ...
    // SEO Tool
    seo_btn_analyze: 'SEO Analizini Başlat',
    seo_analyzing: 'Sayfa Taranıyor...',
    seo_score_title: 'SEO Sağlık Puanı',
    seo_rec_title: 'Öneriler',
    seo_issue_title: 'Bulunan Sorunlar',
    seo_good_job: 'İyi iş!',
    seo_reg_tools: 'Arama Motoru Kaydı',
    seo_reg_gsc: 'Google Search Console\'a Kaydol',
    seo_reg_bing: 'Bing Webmaster\'a Kaydol',
    seo_missing_h1: 'H1 Etiketi Eksik',
    seo_title_short: 'Başlık çok kısa',
    seo_desc_missing: 'Meta Açıklama Eksik',
    seo_alt_missing: 'Alt metni olmayan görseller',
    seo_missing_og: 'Sosyal medya etiketleri eksik',
    ...
    nav_gsheet: 'Çek Yönetimi (Google Sheets)',
    gsheet_connect_title: 'Google Hesabına Bağlan',
    gsheet_connect_desc: 'İade edilen çekleri güvenli bir ortamda yönetmek için lütfen hesabınızı bağlayın.',
    gsheet_btn_connect: 'Google ile Giriş Yap',
    gsheet_syncing: 'Senkronize ediliyor...',
    gsheet_synced: 'Senkronize edildi',
    gsheet_filename: 'İade_Edilen_Çekler_Listesi_1404',
  },
  it: {
    app_title: 'HesabrasYar',
    app_subtitle: 'Teamyar Audit AI',
    ...
    nav_chat: 'Chat AI',
    nav_finetuning: 'Fine-tuning',
    nav_resources: 'Risorse e Strumenti SEO',
    ...
    res_title: 'Knowledge Base & Strumenti SEO',
    res_subtitle: 'Nuovi Standard Contabili e Controllo SEO',
    res_tab_files: 'File e Standard',
    res_tab_seo: 'Analizzatore SEO',
    ...
    // SEO Tool
    seo_btn_analyze: 'Avvia Analisi SEO',
    seo_analyzing: 'Scansione Pagina...',
    seo_score_title: 'Punteggio Salute SEO',
    seo_rec_title: 'Raccomandazioni',
    seo_issue_title: 'Problemi Rilevati',
    seo_good_job: 'Ottimo lavoro!',
    seo_reg_tools: 'Registrazione Motori di Ricerca',
    seo_reg_gsc: 'Registra su Google Search Console',
    seo_reg_bing: 'Registra su Bing Webmaster',
    seo_missing_h1: 'Tag H1 Mancante',
    seo_title_short: 'Titolo troppo corto',
    seo_desc_missing: 'Meta Description mancante',
    seo_alt_missing: 'Immagini senza Alt text',
    seo_missing_og: 'Tag social mancanti',
    ...
    nav_gsheet: 'Gestione Assegni (Google Sheets)',
    gsheet_connect_title: 'Connetti Account Google',
    gsheet_connect_desc: 'Per gestire gli assegni restituiti in un ambiente sicuro, connetti il tuo account.',
    gsheet_btn_connect: 'Accedi con Google',
    gsheet_syncing: 'Sincronizzazione...',
    gsheet_synced: 'Sincronizzato',
    gsheet_filename: 'Lista_Assegni_Restituiti_1404',
  }
};
